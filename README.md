...
- **HUD Display**: Shows the name of the currently tracked ore above the hotbar
...
4. **Check the HUD** - the ore name appears above your hotbar when tracking
...
- **No Ore in Range**: The needle spins randomly (like a vanilla compass in the Nether/End)
